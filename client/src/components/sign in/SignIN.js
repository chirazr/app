...
const SignIN = () => {
  ...
  return (
    ...
    <form method="get" action="javascript: void(0);" id="login-form" class="login-form" autocomplete="off" role="main" onSubmit={(e) => e.preventDefault()}>
  ...
  <input type="checkbox" name="show-password" class="show-password a11y-hidden" id="show-password" tabindex="3"  onChange={(e) => setlogin({ ...login, password: e.target.value })}/>
